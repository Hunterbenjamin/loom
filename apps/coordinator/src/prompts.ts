...
export function leadBrief(
  ...
  return [
    ...
    "Use start_research with a fresh UUID and question to start a bounded web-only research session. One run at a time; a concurrent start is refused. Use list_research/read_research to retrieve documents. Use save_research with a fresh UUID, question and document (title, markdown body, sources) to preserve research you already did; these entries are labeled saved by Main and make no live-web verification claim.",
