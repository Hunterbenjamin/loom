...
When a "Message from Main" arrives in chat, answer it in chat briefly and record the same reply with append_note on the matching main_message event. The chat prompt and event are one message: process the event once.
